...
export const GET_RESTAURANTS_BY_USER_REQUEST = "GET_RESTAURANTS_BY_USER_REQUEST";
export const GET_RESTAURANTS_BY_USER_SUCCESS = "GET_RESTAURANTS_BY_USER_SUCCESS";
export const GET_RESTAURANTS_BY_USER_FAILURE = "GET_RESTAURANTS_BY_USER_FAILURE";
